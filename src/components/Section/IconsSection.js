...
export const IconsSection = ({ data, onUpdate }) => {
  ...
  return (
    ...
    //   </div>
    // </section>
    <div style={{backgroundColor: data.sectionBackgroundColor}} className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <h3 style={{ color: data.subTitleColor, fontFamily: data.subTitleFont }} className="mt-6 text-lg/8 text-gray-600">{data.subtitleText}</h3>
        </div>
