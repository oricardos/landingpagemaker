export const sectionConfig = [
  ...
  //   },
  //   form: [
  //     { name: "show", type: "checkbox", label: "Exibir seção", value: "true" },
  //     { name: "logoSrc", type: "file", label: "Logo", value: "" }, //
  //     {
  ...
  //       value: "#3B82F6",
  //     },
  //     { name: "titleText", type: "text", label: "Texto", value: "coco" },
  //     {
  //       name: "titleFont",
  //       type: "text",
  ...
  //     { name: "subtitleText", type: "text", label: "Texto", value: "coco" },
  //     {
  //       name: "subtitleFont",
  //       type: "text",
  ...
  //       value: "#fff",
  //     },
  //     { name: "buttonLink", type: "text", label: "Link do Botão", value: "#" },
  //   ],
  // },
  // {
  //   name: "Hero",
